...
const TEAS = [
  ...
  { id:"yk07", name:"Shikibu no Mukashi", kanji:"式部の昔", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Premium Usucha", price:"$28/30g", sizes:["30g","100g","150g","300g"], status:"active", rating:4.6, notes:{umami:4,sweet:4,bitter:1,astringent:1,body:3}, tags:["gentle sweetness","floral","delicate aroma"], desc:"Gentle sweetness and delicate aroma with smooth mouthfeel. Umami very noticeable from the first sip. Floral rather than nutty. A devoted TikTok following — frequently cited as the best in the YK lineup.", src:"Wakokoro Tea; Community" },
  { id:"yk08", name:"Ogurayama", kanji:"小倉山", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Signature Best-Seller", price:"$23/30g", sizes:["30g","100g","150g","300g"], status:"active", rating:4.4, notes:{umami:4,sweet:3,bitter:2,astringent:2,body:3}, tags:["marine","seaweed","umami","balanced"], desc:"The flagship. Perfectly balances umami and astringency. Marine and seaweed notes dominate. Bold, bright, full-flavored with gorgeous vibrant green. Bitterness manageable as umami kicks in.", src:"Wakokoro Tea; The Steeping Room" },
  { id:"yk09", name:"Yomo no Kaori", kanji:"四方の薫", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"General Usucha", price:"$17/30g", sizes:["30g","100g","150g","300g"], status:"active", rating:4.0, notes:{umami:3,sweet:2,bitter:2,astringent:1,body:2}, tags:["earthy","grassy","nutty","mild"], desc:"Earthy, grassy, slightly nutty. Light-to-medium body. Milder umami than Ogurayama. Solid dependable everyday matcha on the gentler side.", src:"Community reviews" },
  { id:"yk10", name:"Samidori", kanji:"さみどり", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Daily Usucha", price:"$14/30g", sizes:["30g","100g","150g","300g"], status:"active", rating:4.3, notes:{umami:3,sweet:3,bitter:1,astringent:1,body:3}, tags:["creamy","roasted","nutty","fragrant"], desc:"Single-origin Samidori cultivar. Creamy texture, pronounced umami, roasted nutty character. Fragrant rather than seaweed-forward — the inverse of Ogurayama.", src:"Matchajp; Wakokoro Tea" },
  { id:"yk11", name:"Matsukaze", kanji:"松風", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Entry Ceremonial", price:"$12/30g", sizes:["30g","100g","150g","300g"], status:"active", rating:4.1, notes:{umami:2,sweet:2,bitter:2,astringent:2,body:3}, tags:["dark chocolate","coffee","citrus peel"], desc:"Bold with dark chocolate, coffee, and citrus peel. Harmonious umami and mild refreshing bitterness. Named for the sound of boiling water resembling wind in pines. Incredible value.", src:"The Steeping Room; Wakokoro" },
  { id:"yk11b", name:"Kiwami no Mukashi", kanji:"極の昔", aliases:["Kiwami"], producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Koicha", school:null, grade:"Supplemental Top Tier", price:"Varies", sizes:["Varies by retailer"], status:"limited", rating:4.6, notes:{umami:5,sweet:4,bitter:1,astringent:1,body:5}, tags:["dense umami","polished sweetness","thick finish","high ceremonial"], desc:"Supplemental top-tier Yamamasa listing associated with koicha use. Built for a dense, velvety bowl with deep umami, measured sweetness, and a long composed finish rather than flashy bitterness.", src:"User-provided lineup; inferred from Yamamasa tiering" },
  { id:"yk11c", name:"Shoun", kanji:"松雲", aliases:["Shōun"], producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Koicha", school:null, grade:"Supplemental Koicha", price:"Varies", sizes:["Varies by retailer"], status:"limited", rating:4.4, notes:{umami:4,sweet:4,bitter:1,astringent:1,body:4}, tags:["smooth","creamy","quiet sweetness","long finish"], desc:"Community-sourced Yamamasa koicha-style listing centered on smoothness. Expected profile is creamy, rounded, and quietly sweet with enough body for thicker preparation.", src:"User-provided lineup; inferred from Yamamasa tiering" },
  { id:"yk11d", name:"Houn", kanji:"宝雲", aliases:["Hōun"], producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Koicha", school:null, grade:"Supplemental Koicha", price:"Varies", sizes:["Varies by retailer"], status:"limited", rating:4.3, notes:{umami:4,sweet:4,bitter:1,astringent:1,body:4}, tags:["balanced","mellow sweetness","silky","calm"], desc:"Balanced supplemental koicha listing. Sits between rich and gentle, with mellow sweetness, restrained bitterness, and a silky, centered feel in the bowl.", src:"User-provided lineup; community retailer references" },
  { id:"yk11e", name:"Asahi", kanji:"あさひ", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Single Cultivar / High Ceremonial", price:"Varies", sizes:["Varies by retailer"], status:"limited", rating:4.5, notes:{umami:5,sweet:4,bitter:1,astringent:1,body:4}, tags:["single cultivar","bright green","deep umami","elegant sweetness"], desc:"Built around the prized Asahi tencha cultivar that Yamamasa helped select. Expect saturated green color, layered umami, elegant sweetness, and very low bitterness for a refined usucha or lighter koicha-style preparation.", src:"Kyoto Monodzukuri Navi; Cha Circle; user-provided lineup" },
  { id:"yk11f", name:"Uji no Tsuyu", kanji:"宇治の露", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Premium Usucha", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:4.2, notes:{umami:3,sweet:3,bitter:1,astringent:1,body:3}, tags:["smooth","refreshing","green sweetness","easy daily"], desc:"Smooth premium-usucha style entry with a softer, greener presentation than the flagship Yamamasa bowls. Designed to be easy to drink quickly while still feeling polished.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11g", name:"Waka no Shiro", kanji:"若の白", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Light Ceremonial", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:4.1, notes:{umami:3,sweet:3,bitter:1,astringent:2,body:2}, tags:["light-bodied","airy","soft sweetness","delicate"], desc:"A lighter ceremonial-style Yamamasa listing. More delicate than dense, with airy body, soft sweetness, and a clean finish suited to repeated everyday bowls.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11h", name:"Aonami", kanji:"青波", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Everyday Usucha", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:3.9, notes:{umami:2,sweet:2,bitter:2,astringent:2,body:2}, tags:["slightly brisk","fresh green","clean finish","daily"], desc:"Everyday usucha with a livelier edge. Brisker and greener than the creamier Yamamasa house staples, making it a practical choice when you want freshness over depth.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11i", name:"Shirakiku", kanji:"白菊", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Everyday Usucha", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:4.0, notes:{umami:2,sweet:3,bitter:1,astringent:1,body:2}, tags:["mild","soft floral","gentle sweetness","approachable"], desc:"A mild Yamamasa-style everyday usucha entry with gentle sweetness and a softer floral impression. More about approachability than dramatic power.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11j", name:"Hatsumukashi", kanji:"初昔", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Entry Usucha", price:"~$26/150g", sizes:["150g"], status:"active", rating:4.0, notes:{umami:2,sweet:2,bitter:2,astringent:2,body:2}, tags:["budget-friendly","cold whisking","easy daily","beginner"], desc:"A beginner-friendly Yamamasa retailer collaboration or supplemental listing with strong value reputation. Reviews describe it as easy to drink, practical for frequent daily use, and especially good when shaken cold or used in larger-volume bowls.", src:"Rakuten Leftzaen reviews; user-provided lineup" },
  { id:"yk11k", name:"Yugen", kanji:"幽玄", aliases:["Yūgen"], producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Mid-Premium Usucha", price:"Varies", sizes:["Varies by retailer"], status:"limited", rating:4.1, notes:{umami:3,sweet:3,bitter:2,astringent:1,body:3}, tags:["deep","quietly nutty","measured bitterness","contemplative"], desc:"Separate Yamamasa-oriented Yugen listing, distinct from Marukyu's better-known blend. The likely profile is deeper and darker than entry Yamamasa usucha, with a contemplative balance of nuttiness, umami, and a small bitter lift.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11l", name:"Seiran", kanji:"青嵐", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Supplemental Entry Usucha", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:3.8, notes:{umami:2,sweet:2,bitter:2,astringent:2,body:2}, tags:["breezy","bright","lean","entry"], desc:"Light entry-style usucha with a breezier, brighter personality. Less creamy than Samidori or Ogurayama, and better suited to drinkers who want a cleaner lean finish.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11m", name:"Mukashi", kanji:"昔", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Generic Entry Line", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:3.7, notes:{umami:2,sweet:2,bitter:2,astringent:2,body:2}, tags:["entry tier","straightforward","clean","simple"], desc:"Catch-all entry for generic Yamamasa-style Mukashi lines sometimes seen through retailers. Best thought of as straightforward daily usucha: modest umami, manageable bitterness, and simple value-driven drinking.", src:"User-provided lineup; inferred positioning" },
  { id:"yk11n", name:"Shiro Blends", kanji:"白系", producer:"Yamamasa Koyamaen", category:"Ceremonial", sub:"Usucha", school:null, grade:"Light Blend Family", price:"Varies", sizes:["Varies by retailer"], status:"active", rating:3.8, notes:{umami:2,sweet:2,bitter:1,astringent:2,body:2}, tags:["light-bodied","soft","pale style","easy"], desc:"Loose family bucket for lighter-bodied white-label or shiro-style Yamamasa blends. Usually gentler, softer, and easier on the palate than the richer Mukashi-side bowls.", src:"User-provided lineup; inferred positioning" },
  ...
  { id:"yk16b", name:"Matcha (Cooking Grade)", kanji:"製菓用抹茶", producer:"Yamamasa Koyamaen", category:"Culinary", sub:"Cooking Grade", school:null, grade:"Bulk Culinary", price:"Varies", sizes:["100g","300g","1kg"], status:"active", rating:3.5, notes:{umami:1,sweet:1,bitter:3,astringent:2,body:3}, tags:["bulk","baking","strong green","café use"], desc:"Generic cooking-grade Yamamasa-style matcha bucket for baking and bulk foodservice. Prioritizes visible matcha character and dependable green color over smooth straight drinking.", src:"Yamamasa official processing page; user-provided lineup" },
  { id:"yk16c", name:"Uji Matcha Powder", kanji:"宇治抹茶", producer:"Yamamasa Koyamaen", category:"Culinary", sub:"Versatile Powder", school:null, grade:"Export / General Purpose", price:"Varies", sizes:["100g","300g","1kg"], status:"active", rating:3.6, notes:{umami:2,sweet:1,bitter:3,astringent:2,body:3}, tags:["versatile","straightforward","green","export"], desc:"General-purpose Uji matcha powder positioned between culinary and approachable daily use. Useful when you want a broad-application powder for drinks, desserts, and casual whisking.", src:"User-provided lineup; inferred from Yamamasa processing range" },
  { id:"yk16d", name:"Latte Matcha", kanji:"宇治抹茶ラテ", producer:"Yamamasa Koyamaen", category:"Culinary", sub:"Latte", school:null, grade:"Milk Blend", price:"~$9/100g", sizes:["100g","1kg"], status:"active", rating:4.0, notes:{umami:2,sweet:4,bitter:2,astringent:1,body:3}, tags:["milk powder","sweetened","rounded","café-friendly"], desc:"Yamamasa's prepared latte-style matcha blend uses high-grade Uji matcha plus milk powder for a mellow, rich, easy-drinking cup. Made to be quick, smooth, and pleasant rather than intensely ceremonial.", src:"Kyoto Yamasan Uji Matcha Latte; user-provided lineup" },
        ...
        {teas.map((tea) => (
          ...
          >
            ...
            <div style={{ display: "flex", gap: 6, marginTop: 8, flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 10, padding: "2px 8px", borderRadius: 999, background: "#efe5d2", color: "#705b3d" }}>
                {tea.category}
              </span>
            </div>
            ...
            <div style={{ marginTop: 10, display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" }}>
              ...
              <div style={{ textAlign: "right", fontSize: 11, color: "#5c4a33" }}>
                <div style={{ fontWeight: 700 }}>{tea.grade}</div>
                <div style={{ marginTop: 2, color: "#806f55" }}>{tea.sizes.join(" · ")}</div>
              </div>
            </div>
