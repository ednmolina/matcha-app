  ...
  const filtered = useMemo(() => {
    const items = TEAS.filter((tea) => {
      ...
      return (
        ...
        tea.kanji.includes(search) ||
        tea.desc.toLowerCase().includes(search) ||
        (tea.school && tea.school.toLowerCase().includes(search)) ||
        tea.tags.some((tag) => tag.toLowerCase().includes(search)) ||
        tea.sub.toLowerCase().includes(search)
      );
    });
